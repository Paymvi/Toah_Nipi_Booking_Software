...
<div className="calendar-tooltip-header">
  ...
  <strong className="calendar-tooltip-title">
    {segment.inquiry.organizationName}
  </strong>
  ...
  <div className="calendar-tooltip-status">
    ...
    <span
      className={`calendar-status-dot calendar-status-dot-${statusInfo.color}`}
    ></span>


    <div className="calendar-tooltip-status-text">
